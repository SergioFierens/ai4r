...
module Ai4r
  module Clusterers
    class WardLinkageHierarchicalTest < Minitest::Test
      ...
      def test_linkage_distance
        ...
        assert_in_delta 123.4166,
                        clusterer.send(:linkage_distance, 0, 1, 2), 0.0001
        assert_equal 27.75, clusterer.send(:linkage_distance, 4, 2, 5)
      end
