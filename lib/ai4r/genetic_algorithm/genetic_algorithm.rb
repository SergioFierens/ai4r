...
module Ai4r
  ...
  module GeneticAlgorithm
    ...
    class GeneticSearch
      ...
      def selection
        raise 'Population is empty' if @population.empty?
    ...
    class Chromosome
      ...
      def self.mutate(chromosome)
        return unless chromosome.normalized_fitness && rand < ((1 - chromosome.normalized_fitness) * 0.3)
      ...
      def self.reproduce(a, b)
        ...
        until available.empty?
          ...
          next_token = available.to_a.sample if next_token.nil?
