  ...
  module GeneticAlgorithm
    ...
    class SinglePointCrossover < CrossoverOperator
      ...
      def crossover(parent1, parent2)
        ...
        child1_genes = parent1.genes[0...cut_point] + parent2.genes[cut_point..]
        child2_genes = parent2.genes[0...cut_point] + parent1.genes[cut_point..]
    ...
    class ElitistReplacement < ReplacementOperator
      ...
      def replace(population, offspring)
        ...
        (@elitism_rate * population.size).round
