  ...
  module NeuralNetwork
    ...
    module LearningAlgorithms
      ...
      class GradientDescent
        ...
        def update_weight(current_weight, gradient, step = nil)
      ...
      class LearningAlgorithmFactory
        ...
        def self.compare_algorithms
          ...
          algorithms = [:gradient_descent, :momentum, :adagrad, :rmsprop, :adam, :adamw]
        ...
        def self.recommend_algorithm(problem_characteristics)
          recommendations = {
      ...
      class LearningAnalyzer
        def self.demonstrate_convergence(algorithm_name, options = {})
          ...
          20.times do |step|
            ...
            puts sprintf("%4d | %6.3f | %8.3f | %8.3f | %7.3f", 
        ...
        def self.compare_on_problem(problem_type = :quadratic)
          ...
          algorithms = [:gradient_descent, :momentum, :adagrad, :rmsprop, :adam]
          target = 3.0
          initial_weight = -2.0
          steps = 50
          ...
          results.each do |algo_name, result|
            ...
            puts sprintf("%-12s | %12.4f | %10.6f | %s", 
