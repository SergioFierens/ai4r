  ...
  module NeuralNetwork
    module Regularization
      ...
      class RegularizationTechnique
        def apply_forward(inputs, _training = true)
          inputs
        end
      ...
      class L1Regularization < RegularizationTechnique
        ...
        def penalty(weights)
          ...
          if weights.is_a?(Array)
            @lambda * weights.flatten.sum(&:abs)
          else
            @lambda * weights.abs
          end
        end
      ...
      class ElasticNet < RegularizationTechnique
        ...
        def penalty(weights)
          if weights.is_a?(Array)
            ...
            l1_penalty = @l1_ratio * weights_flat.sum(&:abs)
      ...
      class EarlyStopping
        ...
        def check(validation_loss)
          ...
          @stopped = true if @counter >= @patience
      ...
      class RegularizationStrategy
        ...
        def apply_backward(gradients)
          result = gradients
          @techniques.reverse_each do |technique|
