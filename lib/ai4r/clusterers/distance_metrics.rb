  ...
  module Clusterers
    ...
    class DistanceMetrics
      ...
      def self.compare_metrics_educational
        ...
        metrics.each do |key, metric_info|
          puts "\n#{metric_info[:name]}"
      ...
      def self.k_means_plus_plus
        {
          ...
          function: lambda do |data_set, k, distance_function = nil|
