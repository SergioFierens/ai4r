...
module Ai4r
  module Classifiers
    ...
    class EducationalClassification < Classifier
      ...
      def predict_with_confidence(data_item)
        ...
        when :naive_bayes
          ...
          prediction = probabilities.max_by { |_k, v| v }[0]
      ...
      def calculate_model_complexity
        ...
        when :naive_bayes
          ...
          @data_set.data_labels.length * @data_set.build_domains.sum(&:length)
        else
          'Unknown'
        end
      end
    ...
    class ClassificationConfiguration
      attr_accessor :verbose, :explain_predictions, :cross_validation_folds, :training_split, :validation_split,
                    :test_split, :feature_selection, :preprocessing_steps
    ...
    class ClassificationEvaluator
      ...
      def calculate_class_metrics(predictions, actual_labels)
        ...
        classes.each do |class_name|
          ...
          predictions.zip(actual_labels).count { |pred, actual| pred != class_name && actual != class_name }
    ...
    class ClassificationCrossValidator
      ...
      def validate(data_set, folds = 5)
        ...
        folds.times do |fold|
          ...
          training_items = data_set.data_items[0...start_idx] + data_set.data_items[end_idx..]
    ...
    class ClassificationVisualizer
      ...
      def visualize_confusion_matrix(confusion_matrix)
        ...
        classes.each { |class_name| print format('%8s', class_name) }
        puts

        # Matrix
        classes.each do |actual_class|
          print format('%15s', actual_class)
          classes.each do |predicted_class|
            count = confusion_matrix[actual_class][predicted_class]
            print format('%8d', count)
          end
          puts
        end
      end
