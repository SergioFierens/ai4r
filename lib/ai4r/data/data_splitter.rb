  ...
  module Data
    ...
    class DataSplitter
      ...
      def leave_one_out_split
        ...
        puts "✅ Created #{splits.length} leave-one-out splits" if @verbose
      ...
      def holdout_split(test_size = 0.2, validation_size = 0.2, random_seed = nil)
        ...
        data_items = @dataset.data_items
        if data_items.empty?
          return { train: create_empty_dataset, validation: create_empty_dataset, test: create_empty_dataset }
        end
      ...
      def random_k_fold_split(data_items, k)
        ...
        k.times do |fold_idx|
          ...
          train_items = shuffled_data[0...start_idx] + shuffled_data[end_idx..]
      ...
      def stratified_k_fold_split(data_items, k, stratify_column)
        ...
        k.times do |fold_idx|
          ...
          class_folds.each_value do |folds|
      ...
      def time_ordered_split(data_items, test_size, time_column)
        ...
        test_items = sorted_data[split_point..]
      ...
      def sequential_split(data_items, test_size)
        ...
        test_items = data_items[split_point..]
