...
RSpec.describe Ai4r::Classifiers::NaiveBayes do
  ...
  describe 'Build Tests' do
    ...
    context 'smoothing parameter tests' do
      it 'test_build_laplace_smoothing' do
        ...
        result = classifier.eval(%w[foggy hot high false])
        expect(%w[yes no]).to include(result)
      end
    ...
    context 'parameter validation' do
      it 'test_build_negative_m' do
        ...
        end.to raise_error(ArgumentError, /m must be non-negative/)
      end
    end
  end
  ...
  describe 'Eval Tests' do
    ...
    context 'probabilistic output' do
      it 'test_eval_with_probabilities' do
        ...
        probabilities.each_value do |prob|
          expect(prob).to be >= 0
        end
      end
      ...
      it 'test_eval_log_probabilities' do
        ...
        result2 = classifier.eval(%w[very_rare_value another_rare rare_high rare_false])
    ...
    context 'robustness tests' do
      it 'test_eval_unknown_category' do
        ...
        result = classifier.eval(%w[blizzard freezing extreme unknown])
  ...
  describe 'Probability Distribution Tests' do
    ...
    it 'provides valid probability distributions' do
      test_instances = [
        %w[sunny hot high false],
        %w[overcast mild normal true],
        %w[rainy cool high false]
      ]
    ...
    it 'handles class probability ranking' do
      ...
      instance1 = %w[sunny hot high false] # Common in training
      instance2 = %w[unknown unknown unknown unknown] # All unseen
  ...
  describe 'Integration Tests' do
    it 'works with different smoothing strategies' do
      ...
      results.each { |result| expect(%w[yes no]).to include(result) }
    end
