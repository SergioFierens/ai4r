...
RSpec.describe Ai4r::Classifiers::OneR do
  ...
  describe "Build Tests" do
    context "data type handling" do
      it "test_build_categorical_only" do
        ...
        result = classifier.eval(['sunny', 'hot', 'high'])
    ...
    context "parameter validation" do
      it "test_build_zero_bins" do
        ...
        }.to raise_error(ArgumentError, /bins_count must be positive/)
      end
  ...
  describe "Eval Tests" do
    ...
    context "rule evaluation" do
      it "test_eval_categorical_rule" do
        ...
        result = categorical_classifier.eval(['sunny', 'hot', 'high'])
        
        expect(['yes', 'no']).to include(result)
        
        # Test deterministic behavior
        result1 = categorical_classifier.eval(['sunny', 'hot', 'high'])
        result2 = categorical_classifier.eval(['sunny', 'hot', 'high'])
    ...
    context "error handling" do
      it "handles unknown categorical values" do
        ...
        result = categorical_classifier.eval(['foggy', 'hot', 'high'])
  ...
  describe "Integration Tests" do
    it "works with different data distributions" do
      ...
      expect(['common', 'rare']).to include(result)
    end
