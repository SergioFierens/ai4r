...
RSpec.describe Ai4r::Data::DataSet do
  ...
  let(:sample_labels) { ["city", "age", "result"] }
  ...
  describe "initialization" do
    ...
    it "validates data consistency during initialization" do
      ...
      }.to raise_error(ArgumentError, /Inconsistent row lengths/)
    end
  end
  ...
  describe "#set_data_labels" do
    it "sets data labels for dataset" do
      new_labels = ["location", "years", "outcome"]
    ...
    it "raises error when labels don't match data width" do
      invalid_labels = ["location", "years"]  # Too few labels
      expect {
  ...
  describe "data validation" do
    it "validates data consistency" do
      ...
      expect {
        described_class.new(data_items: valid_data, data_labels: ["col1", "col2", "col3"])
      }.not_to raise_error
    end
    ...
    it "detects inconsistent row lengths" do
      ...
      expect {
        described_class.new(data_items: invalid_data, data_labels: ["col1", "col2", "col3"])
      }.to raise_error(ArgumentError)
    end
    ...
    it "handles empty rows gracefully" do
      ...
      expect {
        described_class.new(data_items: data_with_empty, data_labels: ["col1", "col2", "col3"])
      }.to raise_error(ArgumentError)
    end
  end
  ...
  describe "educational features" do
    it "provides helpful error messages for common mistakes" do
      ...
      }.to raise_error(ArgumentError, /data_items must be an array/)
    end

    it "provides suggestions for data format issues" do
      expect {
        described_class.new(data_items: [1, 2, 3], data_labels: sample_labels)
      }.to raise_error(ArgumentError, /Each data item must be an array/)
    end
  end
