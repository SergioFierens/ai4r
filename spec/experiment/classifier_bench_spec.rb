...
RSpec.describe Ai4r::Experiment::ClassifierBench do
  ...
  describe '#add_classifier' do
    ...
    it 'raises error for invalid classifier' do
      ...
      }.to raise_error(ArgumentError, "Classifier must implement build and eval methods")
    end
  end
  ...
  describe '#run' do
    ...
    it 'validates dataset before running' do
      ...
      }.to raise_error(ArgumentError, "Dataset cannot be empty")
    end
    ...
    it 'requires at least 2 classes' do
      ...
      }.to raise_error(ArgumentError, "Dataset must have at least 2 classes")
    end
  ...
  describe '#export_results' do
    ...
    it 'exports to JSON format' do
      ...
      # Clean up
      File.delete("test_results.json") if File.exist?("test_results.json")
    end
    ...
    it 'exports to HTML format' do
      ...
      # Clean up
      File.delete("test_results.html") if File.exist?("test_results.html")
    end
  ...
  describe 'error handling' do
    ...
    it 'handles nil datasets' do
      expect {
        bench.run(nil)
      }.to raise_error(ArgumentError, "Dataset cannot be nil")
    end

    it 'handles invalid dataset types' do
      expect {
        bench.run("not a dataset")
      }.to raise_error(ArgumentError, "Dataset must be a DataSet instance")
    end

    it 'handles empty datasets' do
      empty_dataset = Ai4r::Data::DataSet.new(data_labels: ['feature', 'class'], data_items: [])
